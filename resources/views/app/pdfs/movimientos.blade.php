              ...
              <table class="table-auto w-full">
                <thead>
                  <tr style="border-bottom: 1px solid #252f3f !important;">
                    ...
                    <th class="px-4 py-2">Fecha de eliminación</th>
                  </tr>
                </thead>
                <tbody>
                  @foreach ($elements as $item)
                    <tr style="border-bottom: 1px solid #252f3f !important;">
                      ...
                      <td style="color: {{ $item->type == 1 ? 'green' : 'red' }}" class="border px-4 py-2">{{ $item->type == 1 ? 'Entrada' : 'Salida' }}</td>
                      ...
                      <td class="border px-4 py-2" style="color: red;">{{ $item->deleted_at }}</td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
